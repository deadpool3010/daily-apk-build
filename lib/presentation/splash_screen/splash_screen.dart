                ...
                children: [
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      ...
                      final circleFilterColor =
                          controller.rightCircleColor.value;
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      ...
                      final startY =
                          screenHeight; // Start from bottom off-screen
                          ...
                          child: Stack(
                            children: [
                              ...
                              if (handFilterColor != null)
                                Opacity(
                                  opacity:
                                      controller.belowHandFadeOpacity.value,
                                  child: ColorFiltered(
                                    colorFilter: ColorFilter.mode(
                                      handFilterColor,
                                      BlendMode.srcIn,
