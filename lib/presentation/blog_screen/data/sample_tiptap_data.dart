/// Sample TipTap JSON data for testing and demonstration
class SampleTiptapData {
  static const Map<String, dynamic> sampleDocument = {
    "type": "doc",
    "content": [
      {
        "type": "heading",
        ...
        "content": [
          {
            ...
            "content": [
              ...
              {
                "type": "text",
                "text": " all common markdown marks. :magic_wand:"
              }
            ]
          }
        ]
  ...
  /// Example: How to navigate to blog screen with TipTap content
  /// 
  /// ```dart
  /// Get.toNamed(
