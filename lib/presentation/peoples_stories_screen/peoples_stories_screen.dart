...
class PeoplesStoriesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.find<PeoplesStoriesScreenController>();
                  ...
                  SizedBox(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        GetBuilder<PeoplesStoriesScreenController>(
                          builder: (ctrl) {
  ...
  Widget _buildExploreButton(BuildContext context) {
    return GestureDetector(
      onTap: () {
        // Navigate to stories list or detail screen with dissolve animation
        // Get.toNamed(AppRoutes.peoplesStoriesListScreen);
      },
      child: Container(
        width: 260,
        height: 60,
